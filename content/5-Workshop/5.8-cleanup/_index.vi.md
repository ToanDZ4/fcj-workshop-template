...
![CloudFront Delete](/images/5-Workshop/5.8-cleanup/Cognito.png)

2. *(Nếu không giữ tên miền)* Truy cập **Route 53** > **Hosted Zones** > Chọn Zone `zopee.xyz` > **Delete**.

![CloudFront Delete](/images/5-Workshop/5.8-cleanup/Route53.png)
...
![CloudFront Delete](/images/5-Workshop/5.8-cleanup/NAT.png)

2. Truy cập **VPC** > **Elastic IPs** > Chọn EIP của NAT Gateway > **Actions** > **Release Elastic IP addresses**.

![CloudFront Delete](/images/5-Workshop/5.8-cleanup/Elastic_IPs.png)
...
![CloudFront Delete](/images/5-Workshop/5.8-cleanup/VPC.png)

4. *(Nếu còn sót)* Truy cập **EC2** > **Security Groups** > Xóa `alb-sg` và `ecs-ec2-sg`,`redis-sg`

![CloudFront Delete](/images/5-Workshop/5.8-cleanup/SG.png)


### 7. Xóa DynamoDB & S3 Buckets
1. Truy cập **DynamoDB** > **Tables** > Chọn bảng dữ liệu > Bấm **Delete**.

![CloudFront Delete](/images/5-Workshop/5.8-cleanup/DynamoDB.png)

2. Truy cập **Amazon S3** > **Buckets**.

![CloudFront Delete](/images/5-Workshop/5.8-cleanup/S3bucket.png)
